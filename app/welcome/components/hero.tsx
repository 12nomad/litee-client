          ...
          <div>
            <div>
              ...
              <h4 className="text-lg mt-4 mb-8">
                ...
                Tool Designed to Make Budgeting and Expense Tracking Effortless
                for Everyone
              </h4>
            </div>
            <div className="mb-8">
              ...
              <div className="flex items-center gap-4 mt-4">
                ...
                <div className="flex flex-col items-start text-sm">
                  <p>
                    <span className="text-caribbean font-bold">250.000+ </span>{" "}
            ...
            <div className="text-caribbean">
              <div className="flex items-center gap-2">
                ...
                <p className="font-medium">Your Top Financial Ally for 2025</p>
              </div>
            </div>
          </div>
        </div>
